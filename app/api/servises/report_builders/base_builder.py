...
class BaseBuilder:
    ...
    def generate_report(self):
        ...
        for period in periods:
            period_expenses = [expense for expense in self.expenses if expense[0] == period]
            ...
            df = df.rename(columns={'category': 'Название статьи расходов', 'summ': 'Сумма трат', 'limit': 'Лимит'})
            df['Процент расхода'] = ((df['Сумма трат'] / df['Лимит']) * 100).round(0).astype(int)
