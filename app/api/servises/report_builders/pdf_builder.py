...
class PDFBuilder(BaseBuilder):
    def write_data(self, data: dict):
        ...
        font_path = os.path.abspath(os.path.join('app', 'api', 'static', 'Roboto-Regular.ttf'))
        ...
        for period, df in data.items():
            ...
            story.append(Spacer(1, 12))  # 1 - это количество колонок, 12 - размер отступа
            ...
            table.setStyle(TableStyle([
                ('BACKGROUND', (0, 0), (-1, 0), colors.Color(0.87, 0.721, 0.529)),
